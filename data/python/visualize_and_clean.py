...
UPSTREAM = [
    ...
    ("HyperADRules", "rules3.txt", "拦截"), ("HyperADRules恶意软件", "rules4.txt", "拦截"), ("adg中文", "rules5.txt", "拦截"),
    ("Tv规则", "rules6.txt", "拦截"), ("EasyPrivacy", "rules7.txt", "拦截"), ("去APP下载", "rules8.txt", "拦截"),
    ("d3ward", "rules9.txt", "拦截"), ("oisd", "rules10.txt", "拦截"), ("秋风", "rules11.txt", "拦截"),
    ("Anti-AD规则", "rules12.txt", "拦截"), ("adblockfilters", "rules13.txt", "拦截"),
    ("GOODBYEADS", "rules14.txt", "拦截"), ("edentwCustom", "rules15.txt", "拦截"),
    ("梦回半仙", "rules16.txt", "拦截"), ("666规则", "rules17.txt", "拦截"), ("AdVoid规则", "rules18.txt", "拦截"), 
    ("AdSuper", "rules19.txt", "拦截"), ("Cats-Team", "rules20.txt", "拦截"), ("lingeringsound", "rules21.txt", "拦截"), 
    ("uniartisan's Adblock", "rules22.txt", "拦截"), ("ABP Merge Rules", "rules23.txt", "拦截"), 
    ("uniartisan's Privacy", "rules24.txt", "拦截"),
    ...
    ("HyperADRules白", "allow9.txt", "白名单"), ("Ealenn白", "allow10.txt", "白名单"), ("666白", "allow11.txt", "白名单"), 
    ("PCDN白", "allow12.txt", "白名单"), ("H-i-H白", "allow13.txt", "白名单"), ("Curated-Allowed", "allow14.txt", "白名单"),
]
